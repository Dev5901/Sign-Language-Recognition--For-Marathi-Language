...
with mp_hands.Hands(
    ...
    while True:
        ...
        checkpoint = torch.load('new_model/final_mask_marathi_best_checkpoint.model')
        ...
        print(pred)
        image = cv2.putText(frame, pred, (right - 200, bottom + 60), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 255, 0),
                            2)  # (0, 0, 255), 2) (255,255,255)
        cv2.imshow("output", image)
        ################################################
